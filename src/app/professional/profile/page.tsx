        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-600">
              {rating ? rating.toFixed(2) : "No ratings yet."}
            </p>

            <h2 className="text-xl font-semibold text-gray-800 mt-6">Verification</h2>
            <p className="text-gray-600">
          ...
          <div className="mt-6">
            <div className="flex justify-between">
              <h2 className="text-xl font-semibold text-gray-800 m-2">Education</h2>
              <button
